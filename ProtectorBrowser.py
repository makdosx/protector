...
class MainWindow(QMainWindow):
	...
	def __init__(self, *args, **kwargs):
		...
		# setting status tip
		back_btn.setStatusTip("Back to prev page")
		...
		stop_btn = QAction("Stop Execute", self)
		stop_btn.setStatusTip("Stop exetuce current page")
		stop_btn.triggered.connect(lambda: self.tabs.currentWidget().stop())
		navtb.addAction(stop_btn)

		# creating first tab
		self.add_new_tab(QUrl('https://ip.me/'), 'Homepage')

		# showing all the components
		self.showMaximized()

		# setting window title
		self.setWindowTitle("Protector Browser")
	...
	def update_title(self, browser):
		...
		self.setWindowTitle("Protector Browser - % s" % title)
...
app.setApplicationName("Protector Browser")

app.setWindowIcon(QtGui.QIcon('/opt/protector/prot.png'))
